...
context('sonor', () => {
  it('Test finalized', () => {
    ...
    cy.server()
      .route('GET', '**/api/campaign/vqs202fgd1x00/survey-units?state=FIN', 'fixture:getSurveyUnitsVqs.json')
      .as('get-finalized-vqs');

    cy.server()
      .route('GET', '**/api/campaign/simpsosfqns2020x00/survey-units?state=FIN', 'fixture:getSurveyUnitsSurveyOnSomething.json')
